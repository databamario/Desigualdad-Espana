...
INE_VALIDATION_RULES = {
    "INE_AROPE_Hogar": {
        ...
        "range_checks": {"Valor": (0, 100), "Anio": (2007, 2025)},
    ...
    "INE_AROPE_CCAA": {
        ...
        "expected_types": {"Anio": int, "CCAA": str, "Indicador": str, "Valor": float},
        "range_checks": {"Valor": (0, 100), "Anio": (2007, 2025)},
    ...
    "INE_AROPE_Laboral": {
        ...
        "range_checks": {"AROPE": (0, 100), "Anio": (2007, 2025)},  # Porcentaje
        "expected_years": range(2013, 2024),
    },
    "INE_IPC_Nacional": {  # Antes: INE_IPC_Anual
        ...
        "critical_columns": [
            "Anio",
            "IPC_Medio_Anual",
        ],  # Inflacion_Anual_% puede ser NULL en 2002
    ...
    "INE_Gini_S80S20_CCAA": {
        ...
        "range_checks": {
            "Gini": (
                0,
                1,
            ),  # Gini normalizado (0=igualdad perfecta, 1=máxima desigualdad)
    ...
    "INE_Umbral_Pobreza_Hogar": {
        ...
        "range_checks": {"Umbral": (0, 50000), "Anio": (2007, 2025)},  # Euros anuales
        "expected_years": range(2008, 2023),
    },
    "INE_Carencia_Material_Decil": {
        "primary_key": ["Anio", "Decil", "Item"],
        "critical_columns": ["Anio", "Decil", "Item", "Porcentaje"],
        "range_checks": {"Porcentaje": (0, 100), "Anio": (2007, 2025)},
    ...
    "INE_Gasto_Medio_Hogar_Quintil": {
        ...
        "range_checks": {"Valor": (0, 100000), "Anio": (2006, 2025)},  # Euros anuales
...
EUROSTAT_VALIDATION_RULES = {
    "EUROSTAT_Gini_UE27": {
        ...
        "expected_types": {"Anio": int, "geo_name": str, "Gini": float},
        "range_checks": {"Gini": (0, 1.0), "Anio": (2015, 2025)},  # Gini en escala 0-1
    ...
    "EUROSTAT_Gini_Espana": {
        ...
        "expected_types": {"Anio": int, "Gini": float},
        "range_checks": {"Gini": (0, 1.0), "Anio": (2015, 2025)},
        "expected_years": range(2015, 2024),
    },
    ...
    "EUROSTAT_AROP_Ranking": {
        ...
        "range_checks": {"AROP_%": (0, 100), "Anio": (2015, 2025)},
        "expected_years": range(2015, 2024),
    },
    "EUROSTAT_AROP_UE27": {
        "primary_key": ["Anio", "geo_name"],
        ...
        "expected_types": {"Anio": int, "geo_name": str, "AROP_%": float},
        "range_checks": {"AROP_%": (0, 100), "Anio": (2015, 2025)},
        "expected_years": range(2015, 2024),
    },
    ...
    "EUROSTAT_Brecha_Pobreza_Ranking": {
        ...
        "range_checks": {"Brecha": (0, 100), "Ranking": (1, 30), "Año": (2015, 2025)},
        "expected_years": range(2015, 2024),
    },
...
ALL_VALIDATION_RULES = {**INE_VALIDATION_RULES, **EUROSTAT_VALIDATION_RULES}
